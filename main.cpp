...
//shunting yard anika gupta 2/16 takes equation puts in tree and prints infix, postfix, or prefix.
int main() {

  // setting head of LLs to null
  ...
  // print output queue (for testing purposes)
  printLinkedList(qhead);

  // adding stuff from output queue to binary tree
